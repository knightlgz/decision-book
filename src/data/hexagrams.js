const HEXAGRAMS = [
  {
    number: "01",
    sc: { name: "乾为天", insight: "商业与职业发展皆有周期，需按部就班从潜伏蓄力到适时出击，严防盛极而衰。" },
  ...
  {
    number: "38",
    sc: { name: "火泽睽", insight: "面对内部利益分歧不强求理念统一，以共同的 KPI 为纽带求同存异。" },
  ...
  },
  {
    ...
    tc: { name: "澤地萃", insight: "依託核心平台聚合生態資源，以極度公平的利益分配機制穩固凝聚力。" }
  },
  {
    number: "46",
